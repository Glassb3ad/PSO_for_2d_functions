...
print(globalBest)
#  visualizeHistory(filename="1d_schwefel_function_PSO_optimization",history=history, fitness=schwefel1D, lowerBound=lowerBound, upperBound=upperBound, iterations=iterations)